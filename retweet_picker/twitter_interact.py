...
TWITTER_CONSUMER_KEY = [config('TWITTER_CONSUMER_KEY'), config('TWITTER_CONSUMER_KEY_1')]
TWITTER_CONSUMER_SECRET = [config('TWITTER_CONSUMER_SECRET'), config('TWITTER_CONSUMER_SECRET_1')]
TWITTER_ACCESS_TOKEN = [config('TWITTER_ACCESS_TOKEN'), config('TWITTER_ACCESS_TOKEN_1')]
TWITTER_ACCESS_SECRET = [config('TWITTER_ACCESS_SECRET'), config('TWITTER_ACCESS_SECRET_1')]
